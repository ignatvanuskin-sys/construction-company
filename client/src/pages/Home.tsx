...
export default function Home(){
  ...
  const visibleFilteredProjects = useMemo(() => paginateProjects(filteredProjects, visibleProjectCount), [filteredProjects, visibleProjectCount]);
  ...
  }, [selectedProjectFilter, selectedProjectYear, selectedProjectRegion, projectQuery]);
  useEffect(() => {
